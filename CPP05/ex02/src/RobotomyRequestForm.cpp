...
RobotomyRequestForm::RobotomyRequestForm(std::string target, int gradeToSign, int gradeToExecute):_target(target), AForm("RobotomyRequestForm", gradeToSign, gradeToExecute) 	// Custom costructor 
{
